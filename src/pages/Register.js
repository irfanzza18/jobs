...
function Register() {
  ...
  return (
    <main className='w-screen min-h-screen flex flex-col bg-gradient-to-tr max-w-[500px] mx-auto p-10'>
        ...
        onSubmit={handleGoogleRegister}>
            <h1 className='text-4xl text-orange-500 text-center' type="submit">Register</h1>
            ...
            <div className='mt-4 flex flex-col gap-2'>
                ...
                <button className='h-10 w-full bg-yellow-500 text-white rounded-lg' type='button'
